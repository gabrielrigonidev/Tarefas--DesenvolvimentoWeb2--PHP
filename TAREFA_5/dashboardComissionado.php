...
if(isset($_POST['btEnviar'])){
  ...
  $c1 = new Comissionado($codigo, $nome, $valorHora, $horasTrabalhadas, $totalVendas);
}
...
<html lang="pt-br">
  <head>
    ...
    <title>Folha de Pagamento | Comissionado</title>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><h1>Folha de Pagamento | Comissionado</h1></li>
        </ul>
          ...
          <div class="col-md-8 justify-content-end">
            <form method="post" action="#" class=" container p-4 mt-5 rounded-2 " >
              ...
              <div class="mb-2 ">
                ...
                <input type="number"  class="form-control" name="totalVendas" required>
              </div>
            ...
            <table class="table">
              <tbody>
                ...
                <tr>
                  ...
                  <td>R$ <?php echo number_format($c1->getTotalVendas(), 2, ',', '.') ; ?></td>
                </tr>
                <tr>
